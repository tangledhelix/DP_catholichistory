...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID623ad113028e7#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=76504) and read all posts
* [x] Open `catholichistory-utf8.txt` in Guiguts
...
* [x] Use `File → Save a Copy As` to make `catholichistory.html`
...
* [x] Re-open `catholichistory-utf8.txt` (if not still open).
...
* [x] Open `catholichistory.html` that was saved previously.
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID623ad113028e7), select SR time period, upload `catholichistory-sr.zip`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID623ad113028e7))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID623ad113028e7)
